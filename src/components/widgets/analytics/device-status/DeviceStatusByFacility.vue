        ...
        <v-card-text>
          <div class="">
            <stacked-bar-chart
              ...
              yAxisLabel=""
              :datasets="datasets"
              colorScheme="tableau.OrangeBlueLight7"
...
export default {
  name: 'device-status-by-facility',
  props: {
    title: {
      type: String,
      required: false,
  ...
  methods: {
    ...
    generateDataSets() {
      const types = [
        { label: 'Online', median: '360', color: colors.yellow },
        { label: 'Offline', median: '10', color: colors.grey },
      ];
      const data = [];
